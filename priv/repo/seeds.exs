...
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 200, name: "Needs Syllabus", is_complete: false})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 300, name: "Weights", is_complete: false})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 400, name: "Assignments", is_complete: false})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 500, name: "Review", is_complete: false})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 600, name: "Help", is_complete: false})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 700, name: "Complete", is_complete: true})
Skoller.Repo.insert!(%Skoller.ClassesStatuses.Status{id: 800, name: "Change", is_complete: true})
