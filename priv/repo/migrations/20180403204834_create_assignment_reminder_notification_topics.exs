defmodule Classnavapi.Repo.Migrations.CreateAssignmentReminderNotificationTopics do
  ...
  def up do
    ...
    flush()
    Repo.insert!(%Classnavapi.Assignments.ReminderNotification.Topic{topic: "Assignment.Reminder.Today"})
    Repo.insert!(%Classnavapi.Assignments.ReminderNotification.Topic{topic: "Assignment.Reminder.Tomorrow"})
    Repo.insert!(%Classnavapi.Assignments.ReminderNotification.Topic{topic: "Assignment.Reminder.Future"})
