defmodule Skoller.Repo.Migrations.SkollerInsights do
  ...
  def up do
    ...
    create table(:student_org_invitations) do
      ...
      add(:name_first, :string, size: 50)
      add(:name_last, :string, size: 50)
      add(:class_ids, {:array, :integer}, default: [])
    ...
    create(unique_index(:student_org_invitations, [:student_id, :organization_id]))
    create(unique_index(:student_org_invitations, [:phone, :organization_id]))
