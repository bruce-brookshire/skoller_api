defmodule Skoller.AssignmentPosts.Notifications do
  @moduledoc """
  ...
  def send_assignment_post_notification(post, student_id) do
    ...
    |> Enum.each(&Notification.create_notification(&1.udid, &1.type, build_assignment_post_msg(post, student, assignment, class), @assignment_post, %{assignment: StructUtils.to_storeable_map(assignment)}))
  end
