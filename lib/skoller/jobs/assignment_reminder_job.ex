defmodule Skoller.AssignmentReminderJob do
  @moduledoc false
  ...
  def handle_info(:work, state) do
    ...
    require Logger
    Logger.info("Running Assignment Reminder Job: " <> to_string(Time.utc_now))

    DateTime.utc_now
    |> AssignmentNotifications.send_assignment_reminder_notifications()
