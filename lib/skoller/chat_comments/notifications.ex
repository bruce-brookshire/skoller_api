defmodule Skoller.ChatComments.Notifications do
  ...
  def send_new_comment_notification(comment, student_id) do
    ...
    |> Enum.each(&Notification.create_notification(&1.udid, &1.type, &1.msg, @class_chat_comment, %{chat_post_id: comment.chat_post_id, class_id: comment.chat_post.class_id}))
  end
