defmodule Skoller.Schema.Enum.Subscriptions.ExpirationIntentType do
  defmacro __using__(_) do
    quote do
      @type(expiration_intent_type :: :apple_cancelled, :apple_billing_error, :apple_non_consent_price_increase, :apple_product_not_available, :apple_other)
      @expiration_intent_values [:apple_cancelled, :apple_billing_error, :apple_non_consent_price_increase, :apple_product_not_available, :apple_other]
