defmodule Skoller.StudentClasses.ConversionQueries do
  ...
  def get_users_needs_setup_classes() do
    ...
    qry = "select (CURRENT_TIME(0) AT TIME ZONE 'America/Chicago')::time >= (select meet_start_time from classes where id = 783042) and select ((CURRENT_TIME(0) - INTERVAL '1 minutes' * 5) AT TIME ZONE timezone)::time < (select meet_start_time from classes where id = 783042)"
