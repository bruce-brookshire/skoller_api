defmodule Skoller.StudentClasses.Notifications do
  ...
  def send_no_classes_notification(students) do
    ...
    students_with_devices |> Enum.each(&Enum.each(&1.devices, fn(x) -> Notification.create_notification(x.udid, create_no_class_msg(&1), @no_class_category) end))
  end

  defp create_no_class_msg(_student_with_devices) do
    "test"
  end
end