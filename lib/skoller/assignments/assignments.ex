defmodule Skoller.Assignments do
  ...
  ## Returns
  `[%{post: Skoller.Assignment.Post, assignment: Skoller.Assignments.Assignment, class: Skoller.Schools.Class, student_assignment: Skoller.StudentAssignments.StudentAssignment}]`
  or `[]`
  """
