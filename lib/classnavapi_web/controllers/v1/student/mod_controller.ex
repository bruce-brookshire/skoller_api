defmodule ClassnavapiWeb.Api.V1.Student.ModController do
  ...
  def index(conn, %{"student_id" => student_id}) do
    ...
    |> where([mod, action, sc, sa], mod.assignment_mod_type_id not in [@new_assignment_mod, @delete_assignment_mod] or (is_nil(sa.id) and mod.assignment_mod_type_id == @new_assignment_mod))
