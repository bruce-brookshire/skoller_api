defmodule SkollerWeb.Api.V1.EmailPreferenceController do
  ...
  def index(conn, %{"user_id" => user_id}) do
    ...
    conn
    |> put_view(UserEmailPreferenceView)
    |> render("show.json", user_email_preference: user_email_preference)
  end
  ...
  def update(conn, %{"user_id" => user_id, "email" => email} = params) do
    ...
    email_preferences =
      EmailPreferences.upsert_email_preferences(params["email_preferences"], user_id)
