defmodule SkollerWeb.Api.V1.Organization.OrgStudent.ClassesController do
  ...
  def index(conn, %{"org_student_id" => org_student_id}) do
    %{student_id: student_id} = OrgStudents.get_by_id(org_student_id)
    student_classes =
