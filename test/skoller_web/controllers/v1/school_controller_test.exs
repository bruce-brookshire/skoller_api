defmodule SkollerWeb.Api.V1.SchoolControllerTest do
    use SkollerWeb.ConnCase
  
    # alias Skoller.Repo
    # alias Skoller.School
  
    setup do
      {:ok, jwt, _} = Skoller.Auth.encode_and_sign(%{:id => 1}, %{typ: "access"})
      {:ok, %{jwt: jwt}}
    end
    ...
    #   school = Skoller.School.changeset_insert(%Skoller.School{}, @valid_school_attrs)
    #   |> Repo.insert!
